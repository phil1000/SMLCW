...
public class MulInstructionTest {
	...
	MulInstruction instructionTest;
	int op1Test = 28;
	int op2Test = 10;
	int resultTest = 3; 
	String labelTest = "labTest";
	String opcodeTest = "mul";
	int op1TestValue = 96;
	int op2TestValue = 69;
	...
	public void setUp() throws Exception {
		...
		instructionTest = new MulInstruction(labelTest,resultTest,op1Test,op2Test);
	...
	public void testMulInstructionStringString() {
		...
		instructionTest = new MulInstruction("labTest2", "bypassing2ndAddConstructor");
